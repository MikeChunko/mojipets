...
async function main() {
  ...
  let catEmoji = { codepoint:"😸", name:"cat", img:"public/resources/pets/cat.jpg" }
  let cowEmoji = { codepoint:"🐮", name:"cow", img:"public/resources/pets/cow.jpg" }
  let antEmoji = { codepoint:"🐜", name:"ant", img:"public/resources/pets/ant.jpg" }
  let caterpillarEmoji = { codepoint:"🐛", name:"caterpillar", img:"public/resources/pets/caterpillar.jpg" }
  let pandaEmoji = { codepoint:"🐼", name:"panda", img:"public/resources/pets/panda.jpg" }
  let batEmoji = { codepoint:"🦇", name:"bat", img:"public/resources/pets/bat.jpg" }
  let bearEmoji = { codepoint:"🐻", name:"bear", img:"public/resources/pets/bear.jpg" }
  let foxEmoji = { codepoint:"🦊", name:"fox", img:"public/resources/pets/fox.jpg" }
  let giraffeEmoji = { codepoint:"🦒", name:"giraffe", img:"public/resources/pets/giraffe.jpg" }
  let hedgehogEmoji = { codepoint:"🦔", name:"hedgehog", img:"public/resources/pets/hedgehog.jpg" }
  let ratEmoji = { codepoint:"🐀", name:"rat", img:"public/resources/pets/rat.jpg" }
  let snowmanEmoji = { codepoint:"☃️", name:"snowman", img:"public/resources/pets/snowman.jpg" }
  let pigEmoji = { codepoint:"🐷", name:"pig", img:"public/resources/pets/pig.jpg" }
  let pizzaEmoji = { codepoint:"🍕", name:"pizza", img:"public/resources/food/pizza.jpg" }
  let pieEmoji = { codepoint:"🥧", name:"pie", img:"public/resources/food/pie.jpg" }
  let melonEmoji = { codepoint:"🍈", name:"melon", img:"public/resources/food/melon.jpg" }
  let mangoEmoji = { codepoint:"🥭", name:"mango", img:"public/resources/food/mango.jpg" }
  let mobEmoji = { codepoint:"🍖", name:"meat on bone", img:"public/resources/food/meat_on_bone.jpg" }
  let falaffelEmoji = { codepoint:"🧆", name:"falaffel", img:"public/resources/food/falaffel.jpg" }
  let bagelEmoji = { codepoint:"🥯", name:"bagel", img:"public/resources/food/bagel.jpg" }
  let onigiriEmoji = { codepoint:"🍙", name:"onigiri", img:"public/resources/food/onigiri.jpg" }
  let donutEmoji = { codepoint:"🍩", name:"donut", img:"public/resources/food/donut.jpg" }
  let sushiEmoji = { codepoint:"🍣", name:"sushi", img:"public/resources/food/sushi.jpg" }
